//Chức năng getRecommend này có 2 tình huống:
//Người dùng chưa có lịch sử mượn sách: Gợi ý sách phổ biến nhất trong hệ thống.
//Người dùng có lịch sử mượn sách: Dựa trên thể loại và tác giả mà người dùng đã mượn nhiều nhất, gợi ý sách liên quan.
//Chức năng này giúp cá nhân hóa đề xuất sách, giúp người dùng tìm được sách phù hợp hơn với sở thích của họ.
