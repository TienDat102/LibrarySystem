//Chức năng này đảm bảo rằng khi người dùng mượn một cuốn sách, thông tin mượn sẽ được lưu vào cơ sở dữ liệu,
// và đồng thời cập nhật số lượng mượn của tác giả và thể loại sách
